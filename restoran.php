            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text text-center">
                        <h3>Restoran</h3>
                        <p>Hidangan kuliner khas kendal yang mantul</p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <ul class="instagram_row flex-wrap">
                                ...
                                <li>
                                    <a href="detail-restoran.php?id=<?=base64_encode($pecahFotoGalRes['id_restoran']); ?>">
                                        <img class="" src="adist/dmin-dolano/dist/img/restaurant-gallery/<?=$pecahFotoGalRes['foto_1']; ?>" alt="Foto galeri restoran" width="100%" height="60px">
                                    </a>
                                </li>
                                <?php } ?>
